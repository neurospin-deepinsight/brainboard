...
# Configure gallery
sphinx_gallery_conf = {
    "doc_module": "brainboard",
    "backreferences_dir": os.path.join("brainboard", "gallery"),
    "examples_dirs": os.path.join(os.pardir, "examples"),
    "gallery_dirs": "auto_gallery",
    "reference_url": {"brainboard": None}}
...
project = u"brainboard"
copyright = u"""{0}, brainboard developers <antoine.grigis@cea.fr>""".format(
...
html_title = "brainboard"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "brainboard"
...
# [howto/manual]).
latex_documents = [
    ("index", "brainboard.tex", "brainboard Documentation", """brainboard developers""",
     "manual"),
]
